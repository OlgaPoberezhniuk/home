(function () {
    ...
    document.querySelectorAll('.tabs').forEach(function (tabsElement) {
        ...
        var selectElement = tabsElement.querySelector('.tabs-select'),
            ...
            newTab = "tabs-container-tab-selected";


        console.log('current value: ', selectElement.value);

        getTabByName(tabsContainerElement, selectElement.value).classList.add(newTab);
        ...
        selectElement.onchange = function () {
            ...
            document.querySelector("." + newTab).classList.remove(newTab);
